...
#        with the nrf24l01+.
# Hardware platform: Netduino Plua 2
#
# Author name: Chris Rieger
# Creation date: 010712
# Revision date (name): 160314 MDS
# Changes implemented (date): 211212 Renamed functions and modified for new prac
        spec
#(Comments): 
------------------------------------------------------------------------------*/
...
#define NRF_SPI_CS_PIN	BRD_SPI_CS_PIN
#endif

#ifndef NRF_SPI_CS_GPIO_PORT
#define NRF_SPI_CS_GPIO_PORT	BRD_SPI_CS_GPIO_PORT
#endif

#ifndef __NRF_SPI_CS_GPIO_CLK
#define __NRF_SPI_CS_GPIO_CLK	__BRD_SPI_CS_GPIO_CLK()
#endif
...
#define NRF24L01P_RF_CHANNEL_DEFAULT	40
